...
# Database: finance4
# Generation Time: 2018-07-20 00:41:38 +0000
# ************************************************************
...
INSERT INTO `distributions` (`distributionId`, `preparedBy`, `preparedDate`, `destination`, `receivedBy`, `receivedDate`, `status`, `statusDate`, `remarks`, `isValid`)
VALUES
	(1,'Bonnie','2017-11-26','MPC','Totong','2017-11-26','closed','2017-11-26','Repaired and in good working order',''),
	(2,'Bonnie','2017-12-23','TTC','Aileen','2017-12-23','delivered','2017-12-23','',''),
	(3,'Warren','2017-11-06','MOEIT','Warren','2017-11-06','closed','2017-11-06','In service at MOEIT',''),
	(4,'Bonnie','2018-02-06','BEA-Transportation','Godinez','2018-02-06','delivered','2018-02-06',NULL,''),
	(5,'Bonnie','2018-02-16','BEA-Transportation','Godinez','2018-02-16','delivered','2018-02-16',NULL,''),
	(6,'Bonnie','2018-01-22','BEA','Loi','2018-01-22','delivered','2018-01-22',NULL,'');
...
VALUES
	(32,1,6,24,1.000,NULL,NULL,NULL,''),
	...
	(39,2,13,64,30.000,NULL,NULL,NULL,''),
...
VALUES
	(1,1,'BEA Transportation Services','Godinez','2017-10-01',709,'Bonnie Imeong','2017-10-06','Repair Bus #1',3,'Temp001.01','2017-11-10',1143.000,NULL,NULL,NULL,1143.000,NULL,NULL,NULL,NULL,''),
...
VALUES
	...
	(5,'2018-13',NULL,NULL,NULL,709,'Bonnie Imeong','2017-10-11',5,'W.C.T.C Ace Hardware','Requesting items to be used at George B. Harris Elementary School.',3,341.000,NULL,'2017-10-11','2017-10-12','Regular',NULL,NULL,341.000,NULL,NULL,NULL,''),
...
VALUES
	...
	(59,5,'1322','EBOE03','OPR',NULL,'1420','Trimmer Head',4.000,'Each',26.250,105.000,NULL,''),
